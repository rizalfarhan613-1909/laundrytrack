        ...
        <form method="POST" action="{{ route('admin.inventory.store') }}" class="p-6 space-y-4">
            ...
            <div class="flex items-center gap-3 pt-2">
                <button type="button" 
                        ...
                        class="w-full bg-gray-100 text-gray-600 py-2.5 rounded-xl font-semibold text-sm hover:bg-gray-200 transition-colors">
                    Batal
                </button>
                <button type="submit" 
                        class="w-full bg-blue-600 text-white py-2.5 rounded-xl font-semibold text-sm hover:bg-blue-700 transition-colors">
                    Tambah Item
                </button>
            </div>
        </form>
